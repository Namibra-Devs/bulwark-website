...
if (isset($_GET['eventid'])) {
    ...
    $eventpost = new Admin($pdo, 'tbl_events');
    $eventpostFullResult = $eventpost->read("event_id", $id);
    $eventpostResult = $eventpostFullResult[0];
    // print_r($eventpostResult);
} else {
    //post doesnt exist
        ...
        <div class="girls-education-programmes" data-aos="flip-down">
            ...
            <div class="girls-education-programmes-details">
                <div class="about-img">
                    ...
                    <img src="./assets/uploads/<?php echo $eventpostResult['photo'] ?>" width="100%">
                </div>
                <h1>TITLE: <?php echo $eventpostResult['event_title'] ?></h1>
                <div>
                    <?php echo $eventpostResult['event_content'] ?>
                ...
                <div class="event-details">
                    <p>Date: <?php echo $eventpostResult['event_date'] ?></p>
                    <p>Venue: <?php echo $eventpostResult['event_venue'] ?></p>
                </div>

                <button class="reg-btn"><a href="<?php echo $eventpostResult['event_link'] ?>" target="_blank">Register</a></button>
