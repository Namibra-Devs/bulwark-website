		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<!-- test -->
					<!-- Programme -->
					<li class="treeview <?php if (($cur_page == 'programme-category-add.php') || ($cur_page == 'programme-category.php') || ($cur_page == 'Programme-category-edit.php') || ($cur_page == 'programme-add.php') || ($cur_page == 'programme.php') || ($cur_page == 'programme-edit.php')) {
											echo 'active';
										} ?>">
						<a href="#">
							<i class="fa fa-hand-o-right"></i>
						...
						<ul class="treeview-menu">
							<li><a href="programme-category.php"><i class="fa fa-circle-o"></i> Category</a></li>
							<li><a href="programme.php"><i class="fa fa-circle-o"></i> Programmes</a></li>
						</ul>
					</li>
					<!-- test -->
