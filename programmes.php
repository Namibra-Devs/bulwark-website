...
$programmeResult = $programme->readAll("programme_id");
...
// print_r($socialTwitter[0]["social_url"])
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
      ...
      <div class="navbar-list">
        <div class="navbar-list-li">
          <ul>
            ...
            <li><a class="active" href="programmes.php">Programme</a></li>
  ...
  <section class="programmes-container">
    <div class="about-img">
      <h1 data-aos="flip-down">PROGRAMMES</h1>
    </div>
    <div class="top-link">
    ...
    <div class="programmes">
      <?php
      foreach ($programmeResult as $blog) {
      ?>
        <div class="programmes-details" data-aos="zoom-out">
          <img src="./assets/uploads/<?php echo $blog['photo'] ?>" alt="" />
          <div class="programmes-details-info">
            <h4> <?php echo $blog['programme_title'] ?></h4>
            <p>
              <?php echo $blog['programme_content_short'] ?>

            </p>
            <button class="btn">
              <a href="getInvolve.php">Get Involve</a>
            </button>
          </div>
        </div>
        <!-- Girls' Education Program

        The Girls' Education Program aims to provide access to education
        for girls in underprivileged communities, with a particular focus
        on ensuring that girls have access to quality education, remain in
        school, and complete their education.
 -->

      <?php } ?>

      <!-- <div class="programmes-details" data-aos="zoom-in">
        <img src="images/spendy-21.jpg" alt="" />
        <div class="programmes-details-info">
          <h4>Girls' Education Program</h4>
          <p>
            The Girls' Education Program aims to provide access to education
            for girls in underprivileged communities, with a particular focus
            on ensuring that girls have access to quality education, remain in
      ...
      <div class="programmes-details" data-aos="zoom-out-up">
        <img src="images/spendy-26.jpg" alt="" />
        <div class="programmes-details-info">
          <h3>Girls' Education Program</h3>
          <p>
            The Girls' Education Program aims to provide access to education
            for girls in underprivileged communities, with a particular focus
            on ensuring that girls have access to quality education, remain in
      ...
      <div class="girls-education-programmes" data-aos="flip-down">
        <h1>Girls' Education Program</h1>
        <p>
          Program Overview: The Girls' Education Program aims to provide access
          to education for girls in underprivileged communities, with a
          particular focus on ensuring that girls have access to quality
          education, remain in school, and complete their education. Program
          Details:
        </p>
        <ul>
          <li>
            Program Description: The Girls' Education Program works to address
            the barriers that prevent girls from accessing education, such as
            poverty, cultural norms, and gender discrimination. The program
            provides a range of services to support girls' education, including
            scholarships, school supplies, mentoring, and life skills training.
          </li>
          <li>
            Program Objectives: The program aims to improve girls' access to
            education, reduce dropout rates, and increase the number of girls
            who complete their education.
          </li>
          <li>
            Program Outcomes: Since its inception, the Girls' Education Program
            has provided scholarships to over 10,000 girls and supported over 50
            schools in underprivileged communities. The program has helped
            increase girls' enrollment in school and reduce dropout rates.
          </li>
        </ul>
        <button class="btn"><a href="getInvolve.php">Get Involve</a></button>
      </div>
      ...
      <div class="footer-2">
        ...
        <p data-aos="fade-up">
          &#169; <span id="date"></span> SPENDY'S BULWARK NGO. All Right
          Reserved
        </p>
      </div>
  </section>
